...
TEST_CASE( "byte of integer", "[memory]" ) {
    unsigned int n = 0xffaaeedd;  // byte = 8 bit = 2 khone toye hex = 8 ta khone toye binary ee
    unsigned char first_byte = 0xdd; // hex : 1 khone 4 bite vali 16=16 | binary : 4 khone ye bite 2*2*2*2=16
...
TEST_CASE( "array as integer", "[memory]" ) {
    char pch[5] = "AAAA";
