...
#include"catch.hpp"
#include"bits.h" // " "--> files in this directory     | < > --> ketabkhone haye pish farz

TEST_CASE( "count ON bits", "bits" ) {
